    ...
    <AuthGuard inverse>
      <div className="min-h-[80vh] flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-surface border-8 border-on-surface p-10 brutal-shadow relative">
          <form onSubmit={(e) => handleAuth('email', e)} className="space-y-6 mt-6">
            {error && (
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className={`w-full p-4 font-black uppercase text-xl border-4 border-on-surface transition-all flex items-center justify-center gap-4 ${
                isSubmitting 
