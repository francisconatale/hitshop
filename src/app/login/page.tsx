...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setError('OAUTH_ERROR: TERMINATED_BY_USER');
    }
  };
        ...
        <ClientOnly>
          <div className="w-full max-w-md bg-surface border-8 border-on-surface p-10 brutal-shadow relative">
            <form onSubmit={handleEmailLogin} className="space-y-6 mt-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary-container text-on-surface p-4 font-black uppercase text-xl border-4 border-on-surface transition-all hover:invert active:translate-x-1 active:translate-y-1 active:shadow-none"
              >
                Authorize
              </button>
            </form>
